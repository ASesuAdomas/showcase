    ...
    if (editMode) {
        ...
        allDiscounts.forEach((input, i) => {
            input.addEventListener('change', _ => {
                ...
                let discountType = document.querySelector(`input[name="discount-type-${i}"]:checked`);
        ...
        const uppdateButtonSection = document.querySelector('[data-update-button]');
        if (uppdateButtonSection) {
            const updateButton = uppdateButtonSection.querySelector('button');
